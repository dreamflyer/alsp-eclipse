...
public class LanguageServiceAccessor {
	...
	private static Map<StreamConnectionProvider1, LanguageServerDefinition> providersToLSDefinitions = new HashMap<>();
	...
	protected static LanguageServerDefinition getLSDefinition(@NonNull StreamConnectionProvider1 provider) {
