...
public class LanguageServerPlugin extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "org.mulesoft.lsp4e"; //$NON-NLS-1$ ;

	public static final boolean DEBUG = Boolean.parseBoolean(Platform.getDebugOption("org.mulesoft.lsp4e/debug")); //$NON-NLS-1$
